...
// Type: GorillaTag.InDelegateListProcessor`2
...
public class InDelegateListProcessor<T1, T2> : 
  DelegateListProcessorPlusMinus<InDelegateListProcessor<T1, T2>, InAction<T1, T2>>
{
  private T1 m_data1;
  private T2 m_data2;
