...
// Type: GorillaTag.GTLogErrorLimiter
...
public class GTLogErrorLimiter
{
  ...
  {
    get => this._baseMessage;
    set => this._baseMessage = value ?? "__NULL__";
  }
    ...
    [CallerLineNumber] int line = 0)
  {
    ...
    Debug.LogError((object) this.sb.ToString(), context);
    this.sb.Clear();
    this.sb.Append(this.baseMessage);
    --this.countdown;
  ...
  public void Log(Object obj, Object context = null, [CallerMemberName] string caller = "", [CallerFilePath] string sourceFilePath = "", [CallerLineNumber] int line = 0)
  {
    if (!(bool) obj)
      ...
      this.Log(obj.ToString(), caller: nameof (Log), sourceFilePath: "C:\\Users\\root\\GT\\Assets\\GorillaTag\\Shared\\Scripts\\MonkeFX\\GTLogErrorLimiter.cs", line: 137);
  }
    ...
    [CallerLineNumber] int line = 0)
  {
    if (this.occurrenceCount <= 0)
      return;
    this.sb.Insert(0, $"Occurred {this.occurrenceCount} times: ");
    this.Log($"\"{component.GetComponentPath()}\"", obj, caller, sourceFilePath, line);
  }

  public void LogOccurrences(
    Utf16ValueStringBuilder subMessage,
    Object obj = null,
    [CallerMemberName] string caller = "",
    [CallerFilePath] string sourceFilePath = "",
    [CallerLineNumber] int line = 0)
