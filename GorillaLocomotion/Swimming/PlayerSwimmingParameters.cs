...
// Type: GorillaLocomotion.Swimming.PlayerSwimmingParameters
...
public class PlayerSwimmingParameters : ScriptableObject
{
  ...
  public AnimationCurve speedToBouyancyExtension = AnimationCurve.Linear(0.0f, 0.0f, 1f, 1f);
  ...
  public AnimationCurve waterSurfaceJumpPalmFacingCurve = AnimationCurve.Linear(0.0f, 0.0f, 1f, 1f);
  public AnimationCurve waterSurfaceJumpHandVelocityFacingCurve = AnimationCurve.Linear(0.0f, 0.0f, 1f, 1f);
  [Header("Diving")]
  ...
  public AnimationCurve palmFacingToRedirectAmount = AnimationCurve.Linear(0.0f, 0.0f, 1f, 1f);
  public Vector2 palmFacingToRedirectAmountMinMax = Vector2.zero;
  public AnimationCurve swimSpeedToRedirectAmount = AnimationCurve.Linear(0.0f, 0.0f, 1f, 1f);
  public Vector2 swimSpeedToRedirectAmountMinMax = Vector2.zero;
  public AnimationCurve swimSpeedToMaxRedirectAngle = AnimationCurve.Linear(0.0f, 0.0f, 1f, 1f);
  public Vector2 swimSpeedToMaxRedirectAngleMinMax = Vector2.zero;
  public AnimationCurve handSpeedToRedirectAmount = AnimationCurve.Linear(0.0f, 1f, 1f, 0.0f);
  public Vector2 handSpeedToRedirectAmountMinMax = Vector2.zero;
  public AnimationCurve handAccelToRedirectAmount = AnimationCurve.Linear(0.0f, 1f, 1f, 0.0f);
  public Vector2 handAccelToRedirectAmountMinMax = Vector2.zero;
  public AnimationCurve nonDiveDampingHapticsAmount = AnimationCurve.Linear(0.0f, 0.0f, 1f, 1f);
