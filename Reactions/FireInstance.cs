...
// Type: GorillaTag.Reactions.FireInstance
...
public class FireInstance : MonoBehaviour
{
  ...
  protected void Awake() => FireManager.Register(this);

  protected void OnDestroy() => FireManager.Unregister(this);

  protected void OnEnable() => FireManager.OnEnable(this);

  protected void OnDisable() => FireManager.OnDisable(this);

  protected void OnTriggerEnter(Collider other) => FireManager.OnTriggerEnter(this, other);
}
